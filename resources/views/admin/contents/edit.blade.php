...
@section('page-content')
  <div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Edit Content</h1>
    ...
    <div class="card shadow mb-4">
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <form class="user mt-4" method="POST" action="/admin/contents/{{ $content->slug }}"
              enctype="multipart/form-data">
              @csrf
              @method('PUT')
              <div class="form-group">
                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                  name="title" placeholder="Enter Title Content" value="{{ old('title', $content->title) }}" required>
                @error('title')
              ...
              <div class="custom-file col-sm-12 mb-4">
                <input type="file"
                  ...
                  id="image" name="image">
                <label class="custom-file-label py-2" for="image">{{ $content->image }}</label>
              </div>
