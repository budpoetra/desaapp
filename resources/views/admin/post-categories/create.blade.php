...
@section('page-content')
  <div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Create New Post Category</h1>
    ...
    <div class="card shadow mb-4">
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <form class="user mt-3" method="POST" action="/admin/post-categories">
              @csrf
              <div class="form-group">
                <input type="text" class="form-control form-control-user @error('name') is-invalid @enderror"
                  id="name" name="name" placeholder="Enter Name Post Category" value="{{ old('name') }}"
                  required>
                @error('name')
              ...
              <div class="form-group">
                <input type="text" class="form-control form-control-user @error('color') is-invalid @enderror"
                  id="color" name="color" placeholder="Enter Color Post Category" value="{{ old('color') }}"
                  required>
                @error('color')
                  <div class="invalid-feedback">
                    {{ $message }}
