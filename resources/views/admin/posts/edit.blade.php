...
@section('page-content')
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-body">
        <a href="/admin/posts" class="btn btn-primary btn-icon-split">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <form class="user mt-4" method="POST" action="/admin/posts/{{ $post->slug }}"
              enctype="multipart/form-data">
              @csrf
              @method('PUT')
              <div class="form-group">
                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                  name="title" placeholder="Enter Title Post" value="{{ old('title', $post->title) }}" required>
                @error('title')
              ...
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <label class="input-group-text" for="inputGroupSelect01">Choose Category Post</label>
                </div>
