      ...
      <div class="col-lg-9">
        <div class="card shadow mb-4">
          <div class="card-body">
            ...
            <a href="/admin/posts/{{ $post->slug }}/edit" class="btn btn-warning btn-icon-split">
              <span class="icon text-white-50">
                <i class="fas fa-edit"></i>
              </span>
              <span class="text">Edit This Post</span>
            </a>
            <a href="/admin/posts/{{ $post->slug }}" class="btn btn-danger btn-icon-split" data-confirm-delete="true">
              <span class="icon text-white-50">
