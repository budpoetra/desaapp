...
@section('page-content')
  <div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Create New Sub Content</h1>
    ...
    <div class="card shadow mb-4">
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <form class="user mt-4" method="POST" action="/admin/sub-contents" enctype="multipart/form-data">
              @csrf
              ...
              <div class="form-group">
                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                  name="title" placeholder="Enter Title Sub Content" value="{{ old('title') }}" required>
                @error('title')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
