...
@section('page-content')
  <div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Edit Sub Sub Content</h1>
    ...
    <div class="card shadow mb-4">
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <form class="user mt-4" method="POST" action="/admin/sub-sub-contents/{{ $subSubContent->slug }}"
              ...
              <div class="input-group mb-3">
                ...
                <select class="custom-select" id="sub_content_id" name="sub_content_id">
                  @foreach ($subContents as $subContent)
                    <option value="{{ $subContent->id }}"
                      {{ $subContent->id == $subSubContent->sub_content_id ? 'selected' : '' }}>
                      {{ $subContent->title }}</option>
                  @endforeach
                </select>
              ...
              <div class="form-group">
                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                  name="title" placeholder="Enter Title Content" value="{{ old('title', $subSubContent->title) }}"
                  required>
                @error('title')
                  <div class="invalid-feedback">
                    {{ $message }}
              ...
              <div class="custom-file col-sm-12 mb-4">
                <input type="file"
                  ...
                  id="image" name="image">
                <label class="custom-file-label py-2" for="image">{{ $subSubContent->image }}</label>
              </div>
              ...
              @enderror
              <div class="form-group">
                <input id="body" type="hidden" name="body" value="{{ @old('body', $subSubContent->body) }}">
